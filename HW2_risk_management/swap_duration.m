function [p_swap,Dd_swap] = swap_duration(fixed, t_0, T, faceValue, NPayments, r, tau, betaValues, last_rate)
...
[p_fixed, ~, Dd_fixed]=price_duration(t_0, portfolio, r, tau, betaValues);
[p_float, ~, Dd_float]=price_duration(t_0, portfolio, r, tau, betaValues, last_rate);
